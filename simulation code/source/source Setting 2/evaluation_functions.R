...
# evaluation functions, for gev0 operating on output of function mvpp()
# in file mv_postprocessing_gev0 (or ensfc)
...
# input:
#   mvpp_out: output of function mvpp() in file mv_postprocessing_gev0()
...
# input:
#   mvpp_out: output of mvpp() function in file mv_postprocessing_gev0
#   obs: observations in evaluation period, should match mvpp_out (is not checked)
