...
existing <- as.numeric(sapply(flist, FUN = function(x) as.numeric(strsplit(strsplit(x, "_setting2_")[[1]][2], ".Rdata"))))
...
for(filename in flist){
  ...
  ID <- as.numeric(as.numeric(strsplit(strsplit(filename, "_setting2_")[[1]][2], ".Rdata")))
